        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-20 md:top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 w-10 md:h-12 md:w-12 max-sm:left-[1.2rem] absolute rounded-full bg-[rgba(255,255,255,0.03)] dark:bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.1)] dark:border-[rgba(255,255,255,0.1)] flex items-center justify-center backdrop-blur-sm transition-all duration-300 group-hover:scale-110 group-hover:border-[#433ecf] -translate-x-1/2">
