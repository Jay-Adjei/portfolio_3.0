    ...
    <div className="page home-page timeline-container" ref={containerRef}>
      ...
      >
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-20 md:top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 w-10 md:h-12 md:w-12 max-sm:left-[1.12rem] absolute rounded-full bg-[rgba(0,0,0,0.03)] dark:bg-[rgba(255,255,255,0.03)] border border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.1)] flex items-center justify-center backdrop-blur-sm transition-all duration-300 group-hover:scale-110 group-hover:border-[#433ecf] -translate-x-1/2">
                <div className="h-4 w-4 md:h-5 md:w-5 rounded-full bg-gradient-to-br from-[#433ecf] to-[#570978] border-2 border-[rgba(0,0,0,0.2)] dark:border-[rgba(255,255,255,0.2)] transition-all duration-300 group-hover:shadow-lg group-hover:shadow-[#433ecf]/50" />
              </div>
        ...
        <div
          ...
          className="absolute left-8 md:left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-[rgba(0,0,0,0.1)] dark:via-[rgba(255,255,255,0.1)] to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
